        ...
        <View className="gap-4">
          <View className="border-score-ask-line bg-score-ask-soft flex-row items-start gap-3 rounded-2xl border p-4">
            ...
            <View className="flex-1 gap-1">
              ...
              <Typography className="text-score-ask text-sm leading-6">{failure}</Typography>
            </View>
          </View>

          <Typography className="text-muted text-sm leading-6">
            A straight-on shot of a single page, with the whole page in frame and no glare, gives us
